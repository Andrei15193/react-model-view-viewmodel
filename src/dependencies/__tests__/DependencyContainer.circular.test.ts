...
describe('DependencyContainer.circular', (): void => {
    test('Attempting to resolve self referencing dependency throws exception', () => {
        ...
        expect(() => resolve(A))
            .toThrow(new Error('Circular dependency detected while trying to resolve \'A -> A\'.'));
    });
    ...
    test('Attempting to resolve circular dependency throws exception', () => {
        ...
        expect(() => resolve(A))
            .toThrow(new Error('Circular dependency detected while trying to resolve \'A -> B -> C -> A\'.'));
    });
    ...
    test('Attempting to resolve circular dependency with tokens throws exception', () => {
        ...
        expect(() => resolve(A))
            .toThrow(new Error('Circular dependency detected while trying to resolve \'A -> token B -> C -> token A -> token B\'.'));
    });
});